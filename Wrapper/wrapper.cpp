...
extern "C"
{
    ...
    __attribute__((visibility("default")))
    UFeelPair *ufeel_get_emotions(void *processor, size_t *size)
    {
    ...
    __attribute__((visibility("default")))
    void ufeel_free_emotions(UFeelPair *emotions, size_t size)
    {
        if (emotions == nullptr) {
            return;
        }
    ...
    __attribute__((visibility("default")))
    UFeelBoolPair *ufeel_get_directions(void *processor, size_t *size)
    {
        if (processor == nullptr) {
            return nullptr;
        }
    ...
    __attribute__((visibility("default")))
    void ufeel_toggle_speech(void *processor, bool state)
    {
        if (processor == nullptr) {
            return;
        }
