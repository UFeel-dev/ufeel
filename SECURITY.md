...
The security of our codebase and the privacy of users are top priorities of the UFeel project.

## Reporting a Vulnerability

If you discover a security vulnerability or privacy flaw in the UFeel core library or any of our official engine plugins, please do not open a public GitHub issue.
...
2. Provide a detailed report including:
    ...
    - Full file path to the affected file
